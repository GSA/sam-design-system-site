...
export class SamDateComponentExampleComponent {
  ...
  errors = {
   ...
   formHints = {
    startDate: 'Provide the start date for the office. The start date has to be current or in the future',
    endDate: 'Provide the end date for the office. The end date cannot be earlier than the start date',
  };
   ...
   dateErrorSamDate(controlName, comp: SamDateComponent) {
    if (controlName === 'ofcStartDate' && (this.basicInfoForm.value.ofcStartDate === null)) {
