...
var code_example_1_3 = `<button class="sam-ui button primary" type="submit">Submit</button>`;
var code_example_2 = `<sam-button buttonText="Add" buttonType="secondary"></sam-button>`;
var code_example_3 = `<sam-button buttonText="Share" buttonType="tertiary"></sam-button>`;
var code_example_4 = `<sam-button buttonText="Delete" buttonType="negative"></sam-button>`;
var code_example_disabled = `
