...
export class BaseDocPageComponent extends BaseExampleComponent
  ...
  ngOnInit() {
    ...
    if (this.typedoc_target) {
      this.service.getComponentProperties(this.typedoc_target).subscribe(
        (data) => {
    ...
    if (
      this.route.snapshot.data.sections.indexOf('component-example.html') !== -1
    ) {
      this._http
        .get(this.getAssetURI('/component-example.html'), {
    ...
    if (
      this.route.snapshot.data.sections.indexOf('component-example.ts') !== -1
    ) {
      this._http
        .get(this.getAssetURI('component-example.ts'), {
          responseType: 'text' as 'json',
        })
        .subscribe((res: any) => {
          // console.log(res.text());
    ...
    if (this.route.snapshot.data.sections.indexOf('documentation.md') !== -1) {
      this._http
        .get(this.getAssetURI('documentation.md'), {
          responseType: 'text' as 'json',
        })
        .subscribe((res: any) => {
          // console.log(res.text());
    ...
    if (this.route.snapshot.data.sections.indexOf('design.md') !== -1) {
      this._http
        .get(this.getAssetURI('design.md'), { responseType: 'text' as 'json' })
        .subscribe((res: any) => {
          // console.log(res.text());
          ctx.design = res;
        });
    ...
    if (this.route.snapshot.data.sections.indexOf('guidance.md') !== -1) {
      this._http
        .get(this.getAssetURI('guidance.md'), {
          responseType: 'text' as 'json',
        })
        .subscribe((res: any) => {
          // console.log(res.text());
    ...
    if (this.route.snapshot.data.sections.indexOf('implementation.md') !== -1) {
      this._http
        .get(this.getAssetURI('implementation.md'), {
          responseType: 'text' as 'json',
        })
        .subscribe((res: any) => {
          // console.log(res.text());
