...
export const ROUTES: Routes = [
  ...
  { path: 'experimental/layout', component: SamLayoutContentComponentExampleComponent },
  ...
  { path: 'layout/filter-drawer/chip-host', component: ChipHostDirectiveExampleComponent },
  { path: 'layout/filter-drawer', component: BaseDocPageComponent, data: {
    ...
    componentName: 'SamFilterDrawerComponent',
			sections: ['component-example.html','component-example.ts','documentation.md','component-example.html','component-example.ts','documentation.md','component-example.html','component-example.ts','documentation.md','component-example.html','component-example.ts','documentation.md','component-example.html','component-example.ts','documentation.md']}, children: [
    { path: '', component: SamFilterDrawerComponentExampleComponent }
  ]},
  { path: 'layout/filter-drawer/dynamic-chips', component: DynamicChipsDirectiveExampleComponent },
  { path: 'layout/filter-drawer/filter-drawer-chip', component: SamFilterDrawerChipExampleComponent },
  { path: 'layout/filter-drawer/filter-drawer-item', component: SamFilterDrawerItemComponentExampleComponent },
