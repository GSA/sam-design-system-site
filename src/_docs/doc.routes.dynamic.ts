...
export const ROUTES: Routes = [

  {
    path: 'components/accordion', component: BaseDocPageComponent, data: {
      ...
      sections: ['component-example.html', 'component-example.ts', 'design.md', 'documentation.md', 'guidance.md']
    }, children: [
  ...
  },
  {
    path: 'components/actions/action-button', component: BaseDocPageComponent, data: {
      ...
      sections: ['component-example.html', 'component-example.ts', 'documentation.md']
    }, children: [
  ...
  },
  {
    path: 'components/breadcrumbs', component: BaseDocPageComponent, data: {
      ...
      sections: ['component-example.html', 'component-example.ts', 'design.md', 'documentation.md']
    }, children: [
  ...
  },
  {
    path: 'components/data-table', component: BaseDocPageComponent, data: {
      ...
      sections: ['component-example.html', 'component-example.ts', 'data-source.ts', 'data.ts', 'documentation.md', 'guidance.md']
    }, children: [
  ...
  },
  {
    path: 'experimental/hierarchical-tree', component: BaseDocPageComponent, data: {
      ...
      sections: ['component-example.html', 'component-example.ts', 'documentation.md', 'hierarchy-datasource.ts']
    }, children: [
  ...
  { path: 'experimental/youtube', component: SamYoutubeComponentExampleComponent },
  {
    path: 'form-controls/autocomplete', component: BaseDocPageComponent, data: {
      ...
      sections: ['component-example.html', 'component-example.ts', 'design.md', 'documentation.md', 'guidance.md', 'implementation.md']
    }, children: [
  ...
  },
  {
    path: 'form-controls/sam-autocomplete', component: BaseDocPageComponent, data: {
      ...
      sections: ['component.scss', 'component-example.html', 'component-example.ts', 'documentation.md', 'service.ts', 'data.ts', 'service.ts', 'datachildgroup.ts']
    }, children: [
