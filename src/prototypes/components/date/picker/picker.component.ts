...
import {
  ...
  @Component({
    ...
    template: `
    <sam-label-wrapper [label]='label' [hint]="hint" [name]="name">
        ...
        >
          <div class="datepicker__calendar__nav">
            <div tabindex="0"
              ...
              (click)="onArrowClick('left')" (keydown.enter)="onArrowClick('left')"
            >
            ...
            <div tabindex="0"
              class="datepicker__calendar__nav__arrow"
              (click)="onArrowClick('right')" (keydown.enter)="onArrowClick('right')"
            >
              <svg class="datepicker__calendar__nav__chevron" x="0px" y="0px" viewBox="0 0 50 50">
                <g>
